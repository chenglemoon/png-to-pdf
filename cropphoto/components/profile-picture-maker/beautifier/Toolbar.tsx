...
interface ToolbarProps {
    disabled: boolean;
    tool: string;
    toSelect: (type: string) => void;
    isFull: boolean;
    onFullChange: (value: boolean) => void;
    annotateColor: string;
    onAnnotateChange: (e: any) => void;
...
export const Toolbar = ({disabled, tool, toSelect, isFull, onFullChange, annotateColor, onAnnotateChange, annotateWidth, onWidthChange, toCapture, onEmojiSelect}: ToolbarProps) => {
    return (
        <div className="flex items-center">
            ...
            <div className="px-3 mx-1 border-l flex items-center">
                <Button
                    ...
                    shape="circle"
                    disabled={disabled}
                    className={tool === 'rect' ? 'text-[#1677ff] bg-sky-100/50 hover:bg-sky-100 hover:text-[#1677ff]' : undefined}
                ...
                <Button
                    ...
                    shape="circle"
                    disabled={disabled}
                    className={tool === 'filledRect' ? 'text-[#1677ff] bg-sky-100/50 hover:bg-sky-100 hover:text-[#1677ff]' : undefined}
                ...
                <Button
                    ...
                    shape="circle"
                    disabled={disabled}
                    className={tool === 'circle' ? 'text-[#1677ff] bg-sky-100/50 hover:bg-sky-100 hover:text-[#1677ff]' : undefined}
                ...
                <Button
                    ...
                    shape="circle"
                    disabled={disabled}
                    className={tool === 'line' ? 'text-[#1677ff] bg-sky-100/50 hover:bg-sky-100 hover:text-[#1677ff]' : undefined}
                ...
                <Button
                    ...
                    shape="circle"
                    disabled={disabled}
                    className={tool === 'arrow' ? 'text-[#1677ff] bg-sky-100/50 hover:bg-sky-100 hover:text-[#1677ff]' : undefined}
                ...
                <Button
                    ...
                    shape="circle"
                    disabled={disabled}
                    className={tool === 'pencil' ? 'text-[#1677ff] bg-sky-100/50 hover:bg-sky-100 hover:text-[#1677ff]' : undefined}

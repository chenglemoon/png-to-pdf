...
export default function HeroSection() {
  const t = useTranslations("ProfilePictureMaker.hero");

  const handleUploadClick = () => {
    // 优先查找 Beautifier 的文件输入框
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6 w-full">
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden shadow-2xl w-full min-h-[400px] md:min-h-[500px] bg-gradient-to-br from-purple-400 via-pink-400 to-blue-400">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <div className="relative w-[75%] h-[75%] rounded-xl overflow-hidden shadow-2xl ring-4 ring-white/80">
                    <Image
                      src="/pfpmarker-8.jpg"
                      alt="Styled profile picture"
                      fill
                      className="object-cover"
                      priority
                    />

...
import { FileText, Edit, Settings, Download } from "lucide-react";

export default function HowToUse() {
  const t = useTranslations("TextToPdf.howToUse");
            ...
            return (
              ...
              >
                ...
                <motion.h3 
                  ...
                  whileHover={{ color: step.iconColor.replace("text-", "").split(" ")[0] }}
                >
                  {t(step.titleKey)}
                </motion.h3>
                ...
                {index < steps.length - 1 && (
                  <motion.div
                    className="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-blue-200 to-transparent dark:from-blue-800"
                    initial={{ scaleX: 0 }}

...
import { Zap, FileImage, Book, Upload } from "lucide-react";

export default function Features() {
  const t = useTranslations("PdfToTiff.features");
  ...
  const renderIllustration = (type: string) => {
    switch (type) {
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="relative w-full max-w-md">
              <div className="absolute inset-0 flex items-center justify-center">
                <FileImage className="w-24 h-24 text-blue-600" />
      ...
      case "batch":
        return (
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg w-full max-w-md aspect-[4/3] p-4 flex flex-col">
              <div className="grid grid-cols-3 gap-2 mb-2">
                <FileImage className="w-8 h-8 text-green-700" />

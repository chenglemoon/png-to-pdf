...
import FooterLanguageSwitcher from "@/components/footer/FooterLanguageSwitcher";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 py-12 lg:grid-cols-6">
            <div className="w-full flex flex-col sm:flex-row lg:flex-col gap-4 col-span-full md:col-span-2">
              <div className="space-y-4 flex-1">
                ...
                <p className="text-sm p4-4 md:pr-12">{tFooter("tagLine")}</p>
            ...
            {footerLinks.map((section) => {
              // 检查是否是语言选择部分：所有链接都有 useA: true
              const isLanguageSection = section.links.length > 0 && 
                section.links.every(link => link.useA === true);

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative w-full max-w-md">
              ...
              >
                {/* 黄色背景 */}
                <rect width="400" height="300" fill="#FCD34D" />
                
                {/* 左侧：四个图片图标 (2x2网格，稍微重叠) */}
                <g transform="translate(30, 70)">
                  {/* 第一行第一个 */}
                  <g transform="translate(0, 0)">
                    <rect x="0" y="0" width="55" height="55" fill="none" stroke="#000000" strokeWidth="3" rx="2" />
                    <polygon points="12,40 28,18 44,40" fill="none" stroke="#000000" strokeWidth="2.5" />
                    <circle cx="18" cy="22" r="4.5" fill="none" stroke="#000000" strokeWidth="2" />
                  </g>
                ...
                <g transform="translate(170, 125)">
                  {/* 箭头主体 - 更粗 */}
                  <line x1="0" y1="25" x2="60" y2="25" stroke="#000000" strokeWidth="10" strokeLinecap="round" />
                  {/* 箭头头部 */}
                  <polygon points="60,25 42,10 42,40" fill="#000000" />
                </g>
                
                {/* 右侧：PDF文档图标 */}
                <g transform="translate(250, 50)">
                  {/* 文档主体 */}
                  <rect x="0" y="0" width="110" height="150" fill="none" stroke="#000000" strokeWidth="4" rx="2" />
                  
                  {/* 右上角折叠 */}
                  <path d="M 85 0 L 110 0 L 110 25 L 85 0 Z" fill="none" stroke="#000000" strokeWidth="4" strokeLinejoin="round" />
                  <line x1="85" y1="0" x2="110" y2="25" stroke="#000000" strokeWidth="4" />
                  
                  {/* 内部三条水平线 - 不同长度 */}
                  <line x1="18" y1="55" x2="82" y2="55" stroke="#000000" strokeWidth="3.5" />
                  <line x1="18" y1="75" x2="72" y2="75" stroke="#000000" strokeWidth="3.5" />
                  <line x1="18" y1="95" x2="62" y2="95" stroke="#000000" strokeWidth="3.5" />
                  
                  {/* PDF标签 - 黑色矩形，白色文字 */}
                  <rect x="25" y="115" width="60" height="22" fill="#000000" rx="2" />
                  <text x="55" y="126" fill="#FFFFFF" fontSize="13" fontWeight="bold" textAnchor="middle" dominantBaseline="central" fontFamily="Arial, sans-serif">PDF</text>
                </g>
              </svg>
            </div>
          </motion.div>
